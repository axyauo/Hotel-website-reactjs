...
export default function Hotel01() {
  return (
    <>
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              <div className="carousel-caption d-md-block left-slide">
                <p>Discover Luxury and Comfort at Radisson Blue!</p>
              </div>
            </div>
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-md-block right-slide">
                <p>Experience Unmatched Hospitality at Radisson Blue, Where Every Moment is Tailored to Perfection!</p>
              </div>
            </div>
            <div className="carousel-item">
              <div className="carousel-overlay"></div>
              ...
              <div className="carousel-caption d-md-block left-slide">
                <p>Choose Radisson Blue for Unforgettable Vacations and Seamless Corporate Gatherings!</p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-6">
              <div className="explore-content mr-30">
                ...
                <p className="all-content-justify">
                    At Radisson Blue, We Redefine Hospitality: Explore Our Range of Exquisite Amenities and Impeccable Service for the Perfect Getaway or Productive Meeting!
                </p>

                <p className="all-content-justify">
                    Indulge in Unparalleled Luxury: Welcome to Radisson Blue, Where Every Stay Transforms into a Memorable Experience!

                    Embark on a journey of unparalleled luxury, where every moment is meticulously crafted to elevate your experience, as Radisson Blue invites you to immerse yourself in a world of exquisite amenities, impeccable service, and unparalleled hospitality, whether you seek the perfect getaway or a productive meeting venue.
                    Step Into a Realm of Refined Elegance: Radisson Blue Invites You to Experience the Pinnacle of Hospitality, Where Impeccable Service, Stylish Accommodations, and Exceptional Dining Options Await, Providing the Perfect Setting for Your Dream Vacation or Corporate Gathering.
                </p>
      ...
      <MapComponent Address="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3716902.270437184!2d80.95845417230774!3d24.5274387843416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a201922be2bfc49%3A0xe3fa7d75e3f634b0!2sHungry%20Birds!5e0!3m2!1sen!2sin!4v1715168969041!5m2!1sen!2sin" />
